...
public class Alignment {
    ...
    public Alignment(int[] index, CmpH5AlnData data)throws Exception{
        load(index,data);
    }
    public void load(int[] index, CmpH5AlnData data)throws Exception{
    ...
    private CmpH5AlnData data_ = null;
